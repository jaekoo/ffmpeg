...
func (cctxt *Context) Type() MediaType {
	return MediaType(C.int32_t(cctxt.codec_type))
}
...
func (cctxt *Context) SetSampleRate(br int) {
	cctxt.sample_rate = C.int(br)
}

func (cctxt *Context) SetChannels(channels int) {
	cctxt.channels = C.int(channels)
}
...
func (cctx *Context) SetSampleFmt(v int32) {
	cctx.sample_fmt = int32(v)
}

func (cctx *Context) GetSampleFmt() int32 {
	return cctx.sample_fmt
}
