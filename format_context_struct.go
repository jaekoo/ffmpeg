...
func (ctxt *FormatContext) Chapters() **AvChapter {
...
func (ctxt *FormatContext) Internal() *AvFormatInternal {
	return (*AvFormatInternal)(unsafe.Pointer(ctxt.internal))
}

func (ctxt *FormatContext) Pb() *AvIOContext {
	return (*AvIOContext)(unsafe.Pointer(ctxt.pb))
}

func (ctxt *FormatContext) InterruptCallback() AvIOInterruptCB {
	return AvIOInterruptCB(ctxt.interrupt_callback)
}

func (ctxt *FormatContext) Programs() []*AvProgram {
...
func (ctxt *FormatContext) DurationEstimationMethod() AvDurationEstimationMethod {
...
func (ctxt *FormatContext) SetPb(pb *AvIOContext) {
	ctxt.pb = (*C.struct_AVIOContext)(unsafe.Pointer(pb))
}

func (ctxt *FormatContext) Pb2() **AvIOContext {
	return (**AvIOContext)(unsafe.Pointer(&ctxt.pb))
}
